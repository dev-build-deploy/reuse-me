...
type IFileType = "SOURCE" | "BINARY" | "ARCHIVE" | "APPLICATION" | "AUDIO" | "IMAGE" | "TEXT" | "VIDEO" | "DOCUMENTATION" | "SPDX" | "OTHER"
...
const parseFile = (fileName: string, contents: string): IFile => {
  ...
  for (const match of fileTagMatches) {
    ...
    switch (key) {
      case "AttributionText": file.attributionTexts.push(value); break; // TODO: Multiline support
      case "Comment": file.comment = value; break;  // TODO: Multiline support
      case "Contributor": file.fileContributors.push(value); break;
      case "CopyrightText": if (file.copyrightText === undefined && SPDXCopyrightRegex.test(value)) file.copyrightText = value; break;  // TODO: Multiline support
      case "LicenseComments": file.licenseComments = value; break;  // TODO: Multiline support
      case "LicenseConcluded": file.licenseConcluded = value; break;
      case "LicenseInfoInFile": if (file.licenseInfoInFiles.includes(value) === false) file.licenseInfoInFiles.push(value); break;
      case "Notice": file.notice = value; break;  // TODO: Multiline support
      case "Type": file.fileTypes.push(value as IFileType); break; // TODO: Literal type checking
    }
  }
