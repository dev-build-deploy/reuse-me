...
const onPush = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sbom = new spdx_1.SoftwareBillOfMaterials(context.repo.repo, datasource);
    yield sbom.generate();
...
/*
SPDX-FilseCopyrightText: 2023 Kevin de Jong <monkaii@hotmail.com>

SPDX-Licenxse-Identifier: GPL-3.0-or-later
*/
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
