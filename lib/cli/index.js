...
const languages_1 = __nccwpck_require__(9153);
/**
...
const languages_json_1 = __nccwpck_require__(2815);
...
const parser_1 = __nccwpck_require__(7368);
const wildcard_1 = __nccwpck_require__(9409);
/**
 * Debian Copyright
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DebianCopyright = void 0;
var debian_1 = __nccwpck_require__(9502);
Object.defineProperty(exports, "DebianCopyright", ({ enumerable: true, get: function () { return debian_1.DebianCopyright; } }));
...
function generateToken(line) {
    const tokenKeys = Object.keys(DebianTokens);
 ...
 * @internal
 */
function* extractData(paragraph) {
    let currentToken = undefined;
            ...
            if (currentData && currentToken) {
                switch (currentToken) {
                    ...
                    case "Whitespace-separated lists":
                        if (Array.isArray(currentData.data) && line.trim().length > 0) {
                            currentData.data = currentData.data.concat(line
                                .trim()
                                .split(" ")
...
*/
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isWildcardMatch = void 0;
/**
 ...
 * @internal
 */
function isWildcardMatch(fileName, pattern) {
    if (pattern === "*")
        return true;
...
const fixitHint_1 = __nccwpck_require__(8208);
const diff_1 = __nccwpck_require__(5740);
/**
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createPatch = exports.extractFromSarif = exports.extractFromFile = exports.FixItHint = exports.DiagnosticsMessage = exports.DiagnosticsLevelEnum = void 0;
var diagnosticsMessage_1 = __nccwpck_require__(4720);
Object.defineProperty(exports, "DiagnosticsLevelEnum", ({ enumerable: true, get: function () { return diagnosticsMessage_1.DiagnosticsLevelEnum; } }));
Object.defineProperty(exports, "DiagnosticsMessage", ({ enumerable: true, get: function () { return diagnosticsMessage_1.DiagnosticsMessage; } }));
var fixitHint_1 = __nccwpck_require__(8208);
Object.defineProperty(exports, "FixItHint", ({ enumerable: true, get: function () { return fixitHint_1.FixItHint; } }));
var parser_1 = __nccwpck_require__(4492);
...
var diff_1 = __nccwpck_require__(5740);
Object.defineProperty(exports, "createPatch", ({ enumerable: true, get: function () { return diff_1.createPatch; } }));
...
const readline_1 = __importDefault(__nccwpck_require__(3785));
const fs_1 = __importDefault(__nccwpck_require__(9896));
const diagnosticsMessage_1 = __nccwpck_require__(4720);
const sarif = __importStar(__nccwpck_require__(9482));
...
*/
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SpdxFile = exports.SoftwareBillOfMaterials = void 0;
var sbom_1 = __nccwpck_require__(2208);
Object.defineProperty(exports, "SoftwareBillOfMaterials", ({ enumerable: true, get: function () { return sbom_1.SoftwareBillOfMaterials; } }));
var file_1 = __nccwpck_require__(6531);
Object.defineProperty(exports, "SpdxFile", ({ enumerable: true, get: function () { return file_1.SpdxFile; } }));
...
const commentIt = __importStar(__nccwpck_require__(3214));
const debian = __importStar(__nccwpck_require__(1159));
const crypto = __importStar(__nccwpck_require__(6982));
const fs = __importStar(__nccwpck_require__(9896));
const parser = __importStar(__nccwpck_require__(122));
/** @internal */
...
*/
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SoftwareBillOfMaterials = void 0;
const file_1 = __nccwpck_require__(6531);
/**
...
class SoftwareBillOfMaterials {
    ...
    async addFile(file) {
        ...
        const spdxFile = await file_1.SpdxFile.fromFile(file);
...
var log_1 = __nccwpck_require__(2578);
Object.defineProperty(exports, "Log", ({ enumerable: true, get: function () { return log_1.Log; } }));
var run_1 = __nccwpck_require__(9085);
Object.defineProperty(exports, "Run", ({ enumerable: true, get: function () { return run_1.Run; } }));
var tool_1 = __nccwpck_require__(1228);
Object.defineProperty(exports, "Tool", ({ enumerable: true, get: function () { return tool_1.Tool; } }));
var result_1 = __nccwpck_require__(7955);
Object.defineProperty(exports, "Result", ({ enumerable: true, get: function () { return result_1.Result; } }));
var rule_1 = __nccwpck_require__(9064);
...
exports.Log = void 0;
const fs = __importStar(__nccwpck_require__(9896));
const run_1 = __nccwpck_require__(9085);
const interfaces_1 = __nccwpck_require__(5816);
const tool_1 = __nccwpck_require__(1228);
const result_1 = __nccwpck_require__(7955);
...
var
/*istanbul ignore start*/
_base = _interopRequireDefault(__nccwpck_require__(7106))
/*istanbul ignore end*/
;
...
var
/*istanbul ignore start*/
_line = __nccwpck_require__(5129)
/*istanbul ignore end*/
;
...
var
/*istanbul ignore start*/
_params = __nccwpck_require__(4400)
/*istanbul ignore end*/
;
...
var
/*istanbul ignore start*/
_character = __nccwpck_require__(6312)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_word = __nccwpck_require__(1867)
/*istanbul ignore end*/
;
...
var
/*istanbul ignore start*/
_sentence = __nccwpck_require__(9114)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_css = __nccwpck_require__(8336)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_json = __nccwpck_require__(1553)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_array = __nccwpck_require__(9882)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_apply = __nccwpck_require__(2058)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_parse = __nccwpck_require__(6997)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_merge = __nccwpck_require__(6974)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_reverse = __nccwpck_require__(7560)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_create = __nccwpck_require__(3148)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_dmp = __nccwpck_require__(9766)
/*istanbul ignore end*/
;

var
/*istanbul ignore start*/
_xml = __nccwpck_require__(1110)
/*istanbul ignore end*/
;
...
var
/*istanbul ignore start*/
_distanceIterator = _interopRequireDefault(__nccwpck_require__(7572))
/*istanbul ignore end*/
;
...
var
/*istanbul ignore start*/
_array = __nccwpck_require__(6937)
/*istanbul ignore end*/
;
...
class GitSource {
    ...
    async getRootPath() {
        if (this.__ROOT_PATH === undefined) {
            this.__ROOT_PATH = await (0, simple_git_1.default)().revparse({
                "--show-toplevel": null,
            });
        }
    ...
    async listFiles(rootPath) {
        try {
            const tracked = await (0, simple_git_1.default)().raw(["ls-files", "--exclude-standard", "--full-name", rootPath]);
            const untracked = await (0, simple_git_1.default)().raw(["ls-files", "--others", "--exclude-standard", "--full-name", rootPath]);
            const files = tracked + "\n" + untracked;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const fs = __importStar(__nccwpck_require__(9896));
const diagnostics = __importStar(__nccwpck_require__(1811));
const reuse = __importStar(__nccwpck_require__(5013));
const commander_1 = __nccwpck_require__(8909);
const datasources_1 = __nccwpck_require__(997);
...
exports.fileRequirements = fileRequirements;
const fs = __importStar(__nccwpck_require__(9896));
const sarif = __importStar(__nccwpck_require__(9482));
const tool = __importStar(__nccwpck_require__(4618));
const spdx = __importStar(__nccwpck_require__(2756));
const utils_1 = __nccwpck_require__(1798);
/**
 * Validates whether the provided file contains a SPDX Copyright header
 */
function* missingCopyrightInformation(rule, spdxFile) {
    if (spdx.hasValidCopyrightText(spdxFile) === false) {
        yield new sarif.Result((0, utils_1.highlightMessage)(rule.properties().shortDescription?.text ?? "", "Copyright Information"), {
            level: "error",
 ...
 */
function* missingLicenseInformation(rule, spdxFile) {
    if (spdx.hasValidLicense(spdxFile) === false) {
        yield new sarif.Result((0, utils_1.highlightMessage)(rule.properties().shortDescription?.text ?? "", "License Information"), {
            level: "error",
 ...
 */
function* incorrectLicenseFormat(rule, spdxFile) {
    const results = [];
    spdxFile.licenseInfoInFiles
        ...
        .forEach(license => {
        results.push(new sarif.Result((0, utils_1.highlightMessage)((0, utils_1.formatMessage)(rule.properties().shortDescription?.text ?? "", license), license, 'LicenseRef-[letters, numbers, ".", or "-"]'), {
            level: "error",
 ...
 */
function* MissingLicenseFile(rule, sbom) {
    const results = [];
    ...
    missingLicenses.forEach(license => {
        results.push(new sarif.Result((0, utils_1.highlightMessage)((0, utils_1.formatMessage)(rule.properties().shortDescription?.text ?? "", license), "License File", license), {
            level: "error",
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function getRulesFromMapping(mapping) {
    const rules = [];
...
function projectRequirements() {
    ...
    return getRulesFromMapping(ruleMap);
}
// eslint-disable-next-line @typescript-eslint/no-explicit-any
 ...
 */
function formatMessage(str, ...val) {
 ...
 */
function highlightMessage(str, ...val) {
    val.forEach(value => {
...
const sarif = __importStar(__nccwpck_require__(9482));
const tool = __importStar(__nccwpck_require__(4618));
const requirements_1 = __nccwpck_require__(6475);
/**
...
function validateFiles(sbom) {
    const requirements = (0, requirements_1.fileRequirements)();
...
function validateSBOM(sbom) {
    const requirements = (0, requirements_1.projectRequirements)();
    const results = requirements
...
function validate(sbom) {
    ...
    results.forEach(result => result.results.forEach(res => {
        run.addResult(res);
        errorCount += res.properties()?.occurrenceCount ?? 0;
    }));
    return {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"languages":[{"name":"Asciidoc","extensions":[".asciidoc",".adoc",".asc"],"multiline":{"start":"////","end":"////"},"singleline":"//"},{"name":"AWK","extensions":[".awk"],"singleline":"#","singleQuote":true,"doubleQuote":true},{"name":"C","extensions":[".c",".h"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"C++","extensions":[".cpp",".cc",".cxx",".hpp",".hh",".hxx"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"C#","extensions":[".cs"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"CMake","extensions":[".cmake"],"multiline":{"start":"#[[","end":"]]"},"singleline":"#","doubleQuote":true},{"name":"Dart","extensions":[".dart"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"Go","extensions":[".go"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","doubleQuote":true,"backtick":true},{"name":"Groovy","extensions":[".groovy",".gvy",".gy",".gsh"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"Java","extensions":[".java"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"Javascript","extensions":[".js"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true,"backtick":true},{"name":"JSON","extensions":[".json"],"doubleQuote":true},{"name":"Kotlin","extensions":[".kt",".kts"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","doubleQuote":true},{"name":"LUA","extensions":[".lua"],"multiline":{"start":"--[[","end":"]]"},"singleline":"--","singleQuote":true,"doubleQuote":true},{"name":"Markdown","extensions":[".md",".mkd",".mdwn",".mdown",".markdown"],"multiline":{"start":"<!--","end":"-->"}},{"name":"Nix","extensions":[".nix"],"multiline":{"start":"/*","end":"*/"},"singleline":"#","singleQuote":true,"doubleQuote":true},{"name":"Objective-C","extensions":[".m",".mm"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"Plain Text","filenames":[".gitattributes",".gitignore","CODEOWNERS"],"singleline":"#"},{"name":"Perl","extensions":[".pl",".pm"],"multiline":{"start":"=pod","end":"=cut"},"singleline":"#","singleQuote":true,"doubleQuote":true},{"name":"PHP","extensions":[".php"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"Python","extensions":[".py"],"multiline":{"start":"\\"\\"\\"","end":"\\"\\"\\""},"singleline":"#","singleQuote":true,"doubleQuote":true},{"name":"Ruby","extensions":[".rb"],"multiline":{"start":"=begin","end":"=end"},"singleline":"#","singleQuote":true,"doubleQuote":true},{"name":"Rust","extensions":[".rs"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true},{"name":"Scala","extensions":[".scala"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","doubleQuote":true},{"name":"Shell","extensions":[".sh"],"singleline":"#","singleQuote":true,"doubleQuote":true},{"name":"Swift","extensions":[".swift"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","doubleQuote":true},{"name":"Typescript","extensions":[".ts"],"multiline":{"start":"/*","end":"*/"},"singleline":"//","singleQuote":true,"doubleQuote":true,"backtick":true},{"name":"YAML Ain\'t Markup Language","extensions":[".yaml",".yml"],"singleline":"#","singleQuote":true,"doubleQuote":true}]}');
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(9921);
