...
const sarif = __nccwpck_require__(1496);
const tool = __nccwpck_require__(9221);
const spdx = __nccwpck_require__(5967);
const fs = __nccwpck_require__(7147);
...
function* missingCopyrightInformation(rule, spdxFile) {
    if (spdx.hasValidCopyrightText(spdxFile) === false) {
        yield new sarif.Result((0, utils_1.highlightMessage)(rule.get("shortDescription").text, "Copyright Information"), {
            level: "error",
...
function* missingLicenseInformation(rule, spdxFile) {
    if (spdx.hasValidLicense(spdxFile) === false) {
        yield new sarif.Result((0, utils_1.highlightMessage)(rule.get("shortDescription").text, "License Information"), {
            level: "error",
...
function* incorrectLicenseFormat(rule, spdxFile) {
    ...
    spdxFile.licenseInfoInFiles
        ...
        .forEach(license => {
        results.push(new sarif.Result((0, utils_1.highlightMessage)((0, utils_1.formatMessage)(rule.get("shortDescription").text, license), license, 'LicenseRef-[letters, numbers, ".", or "-"]'), {
            level: "error",
...
function* MissingLicenseFile(rule, sbom) {
    ...
    missingLicenses.forEach(license => {
        results.push(new sarif.Result((0, utils_1.highlightMessage)((0, utils_1.formatMessage)(rule.get("shortDescription").text, license), "License File", license), {
            level: "error",
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
const diagnostics = __nccwpck_require__(4657);
const reuse = __nccwpck_require__(2614);
const fs = __nccwpck_require__(7147);
