...
program
    ...
    const sbom = new spdx_1.SoftwareBillOfMaterials("reuseme", new datasources_1.GitSource(true));
    yield sbom.generate();
...
program
    ...
    console.log("----------------------------------------");
    const sbom = new spdx_1.SoftwareBillOfMaterials("reuseme", new datasources_1.GitSource(options.all));
    yield sbom.generate();
