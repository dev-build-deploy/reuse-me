...
const languages_1 = __nccwpck_require__(501);
/**
...
const languages_json_1 = __nccwpck_require__(149);
...
const parser_1 = __nccwpck_require__(126);
const wildcard_1 = __nccwpck_require__(219);
/**
 * Debian Copyright
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DebianCopyright = void 0;
var debian_1 = __nccwpck_require__(827);
...
var sbom_1 = __nccwpck_require__(195);
...
const debian = __importStar(__nccwpck_require__(642));
...
class GitSource {
     ...
     */
    async getFileContents(file, buffer) {
        if (fs.existsSync(file) === false)
            return "";
        if (buffer)
            return this.readBuffer(file);
        else
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.projectRequirements = exports.fileRequirements = exports.RequirementError = void 0;
const diagnose_it_1 = __nccwpck_require__(657);
const spdx = __nccwpck_require__(967);
const fs = __nccwpck_require__(147);
...
class RequirementError extends Error {
    constructor(requirement, identifier) {
        super();
        this.errors = [];
     ...
     */
    addError(highlight, description) {
...
class FL01 {
    constructor() {
        this.id = "FL01";
        this.description = "Each Covered File MUST have Copyright and Licensing Information associated with it";
    }
    validate(spdxFile) {
...
class FL02 {
    constructor() {
        this.id = "FL02";
        this.description = 'The SPDX License Identifier (X) MUST be LicenseRef-[letters, numbers, ".", or "-"] as defined by the SPDX Specification';
    }
    validate(spdxFile) {
        const error = new RequirementError(this, spdxFile.fileName);
        spdxFile.licenseInfoInFiles
            ...
            .forEach(license => {
            error.addError([license, "MUST be LicenseRef-", 'letters, numbers, ".", or "-"'], `The SPDX License Identifier (${license}) MUST be LicenseRef-[letters, numbers, ".", or "-"] as defined by the SPDX Specification`);
        });
        if (error.errors.length > 0)
            return error;
    }
...
class PR01 {
    constructor() {
        this.id = "PR01";
        this.description = "The Project MUST include a License File for every license, but is missing (...)";
    }
    validate(sbom) {
...
class PR02 {
    constructor() {
        this.id = "PR02";
        this.description = "The Project MUST NOT include License Files (X) for licenses under which none of the files in the Project are licensed.";
    }
    validate(sbom, licenses) {
        ...
        localLicenses.forEach(license => {
            ...
            error.addError(["Project MUST NOT include License Files", niceLicense], `The Project MUST NOT include License Files (${niceLicense}) under which none of the files in the Project are licensed`);
        });
        if (error.errors.length > 0)
            return error;
    }
...
class PR03 {
    constructor() {
        this.id = "PR03";
        this.description = "The Project MUST NOT include duplicate SPDX identifiers (...).";
    }
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    validate(sbom, _licenses) {
        const error = new RequirementError(this, sbom.name);
        const spdxIdentifiers = sbom.files.map(file => file.SPDXID);
        spdxIdentifiers.forEach((value, index, array) => {
            if (array.indexOf(value) !== index) {
                error.addError(["Project MUST NOT include duplicate SPDX identifiers", value], `The Project MUST NOT include duplicate SPDX identifiers (${value}).`);
            }
        });
        if (error.errors.length > 0)
            return error;
...
exports.fileRequirements = [new FL01(), new FL02()];
exports.projectRequirements = [new PR01(), new PR02(), new PR03()];
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateSBOM = exports.validateFiles = void 0;
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
const reuse = __nccwpck_require__(614);
const fs = __nccwpck_require__(147);
...
program
    ...
    const projectResults = (0, validator_1.validateSBOM)(sbom, await datasource.getLicenseFiles());
    let errorCount = 0;
    ...
    const results = (0, validator_1.validateFiles)(sbom);
    results
